...
-- One of the most promising **Solutions** is [***The Lightning Network***](https://lightning.network/){:target="_blank"}, developed in 2015 by Joseph Poon and Thaddeus Dryja  
([WhitePaper](https://lightning.network/lightning-network-paper.pdf){:target="_blank"} - Scalable Off-Chain Instant Payments).  
