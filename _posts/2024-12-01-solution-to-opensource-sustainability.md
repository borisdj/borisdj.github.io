...
Also when setting prices avoid awkward amounts like 799, use rounded numbers, plain 800 is fine. Additionally, you can consider accepting **Bitcoin** as payment, as it aligns with the principles *OpenSource Money* (read previous blog posts).
